...
```json
{
  "mcpServers": {
    ...
    "pubmed-data-server": {
      "command": "node",
      "args": ["/path/to/pubmed-server/src/index.js"],
      "env": {
        "ABSTRACT_MODE": "deep",
  ...
  "routing_config": {
    "medical_keywords": ["临床", "治疗", "药物", "副作用", "预后", "检查", "指标", "癌症", "肿瘤", "胰腺", "化疗", "放疗", "免疫"],
    "tech_keywords": ["架构", "方案", "设计", "性能", "优化", "实现", "代码", "系统", "服务"],
    "default_search_mcp": "metaso"
  }
}
```
...
**文档版本**: v0.2  
**更新日期**: 2026-01-15  
**主要变更**: 增强MCP工具集成，优化路由策略，明确核心/可选MCP分类
